...
export class CertificationService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'certification/';
  ...
  //1.to insert certification
  insert(inparam: Certification): Observable<Certification[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_certification_master_create`;//insertMilestonesProject`;
  ...
  update(inparam: Certification): Observable<Certification[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_certification_master_update`;//insertMilestonesProject`;
  ...
  getall(): Observable<Certification[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_certification_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get certification
  getedit(pkid: string): Observable<Certification>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_certification_master_selectedit`;//selectEditMilestone`;
