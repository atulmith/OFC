...
import { Dropdown1 } from '../../city/dropdown1';
...
export class CityService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+"city/";
  }
  /**
  ...
  //1.to insert city
  insert(inparam: City): Observable<Citys[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_city_master_create`;//insertMilestonesProject`;
  ...
  // 2.Update city
  update(inparam: City): Observable<Citys[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_city_master_update`;//insertMilestonesProject`;
  ...
  getallCity(): Observable<City[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_city_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get city
  getedit(pkid: string): Observable<City>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_city_master_selectedit`;//selectEditMilestone`;
...
// 5.Get country for Dropdown
  ...
  getall(): Observable<Citys[]>{
    ...
    var url2 = `${this.baseUrl}WS_vw_city_state_country_details_selectjson`;//selectAllMilestone`;
