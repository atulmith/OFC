...
export class CountryService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'country/';
  ...
  //1.to insert country
  insert(inparam: Country): Observable<Country[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_country_mastercreate`;//insertMilestonesProject`;
  ...
  // 2.Update country
  update(inparam: Country): Observable<Country[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_country_master_update`;//insertMilestonesProject`;
  ...
  getall(): Observable<Country[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_country_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get country
  getedit(pkid: string): Observable<Country>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_country_master_selectedit`;//selectEditMilestone`;
