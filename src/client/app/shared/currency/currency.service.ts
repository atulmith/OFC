...
export class CurrencyService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'currency/';
  ...
  //1.to insert currency
  insert(inparam: Currency): Observable<Currency[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_currency_master_create`;//insertMilestonesProject`;
  ...
  // 2.Update currency
  update(inparam: Currency): Observable<Currency[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_currency_master_update`;//insertMilestonesProject`;
  ...
  getall(): Observable<Currency[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_currency_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get currency
  getedit(pkid: string): Observable<Currency>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_currency_master_selectedit`;//selectEditMilestone`;
