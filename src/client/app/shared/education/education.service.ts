...
export class EducationService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'education/';
  ...
  //1.to insert education
  insert(inparam: Education): Observable<Education[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_education_master_create`;//insertMilestonesProject`;
  ...
  // 2.Update education
  update(inparam: Education): Observable<Education[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_education_master_update`;//insertMilestonesProject`;
  ...
  getall(): Observable<Education[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_education_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get education
  getedit(pkid: string): Observable<Education>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_education_master_selectedit`;//selectEditMilestone`;
