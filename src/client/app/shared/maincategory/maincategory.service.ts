...
import { MainCategory } from '../../maincategory/maincat';
...
export class MainCategoryService {
  ...
  //1.to insert maincategory
  insert(inparam: MainCategory): Observable<MainCategory[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_maincat_master_create`;//insertMilestonesProject`;
  ...
  // 2.Update maincategory
  update(inparam: MainCategory): Observable<MainCategory[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_maincat_master_update`;//insertMilestonesProject`;
  ...
  getall(): Observable<MainCategory[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_maincat_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get maincategory
  getedit(pkid: string): Observable<MainCategory>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_maincat_master_selectedit`;//selectEditMilestone`;
