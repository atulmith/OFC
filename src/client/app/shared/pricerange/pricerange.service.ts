...
export class PriceRangeService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'pricerange/';
  ...
  //1.to insert pricerange
  insert(inparam: PriceRange): Observable<PriceRange[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_pricerange_master_create`;//insertMilestonesProject`;
  ...
  // 2.Update pricerange
  update(inparam: PriceRange): Observable<PriceRange[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_pricerange_master_update`;//insertMilestonesProject`;
  ...
  getall(): Observable<PriceRange[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_pricerange_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get pricerange
  getedit(pkid: string): Observable<PriceRange>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_pricerange_master_selectedit`;//selectEditMilestone`;
