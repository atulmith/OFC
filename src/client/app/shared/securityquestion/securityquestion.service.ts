...
import { Dropdown1 } from '../../securityquestion/dropdown1';
...
export class SecurityquestionService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+"securityquestion/";
  }
  /**
  ...
  //1.to insert securityquestion
  insert(inparam: Securityquestion): Observable<Securityquestion[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_securityquestion_master_create`;//insertMilestonesProject`;
  ...
  // 2.Update securityquestion
  update(inparam: Securityquestion): Observable<Securityquestion[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_securityquestion_master_update`;//insertMilestonesProject`;
  ...
  // 3.get all for Securityquestion
  getallSecurityquestion(): Observable<Securityquestion[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_securityquestion_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get securityquestion
  getedit(pkid: string): Observable<Securityquestion>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_securityquestion_master_selectedit`;//selectEditMilestone`;
...
// 5.Get country for Dropdown
  ...
  // 6.get all for Securityquestions
