...
import { Dropdown1 } from '../../skill/dropdown1';
...
export class SkillService {
  ...
  //1.to insert skill
  insert(inparam: Skill): Observable<SkillGrid[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_skill_master_create`;//insertMilestonesProject`;
  ...
  // 2.Update skill
  update(inparam: Skill): Observable<SkillGrid[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_skill_master_update`;//insertMilestonesProject`;
  ...
  getall(): Observable<SkillGrid[]>{
    ...
    var url2 = `${this.baseUrl}WS_vw_skill_subcat_maincat_details_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get skill
  getedit(pkid: string): Observable<Skill>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_skill_master_selectedit`;//selectEditMilestone`;
...
// 5.Get maincat for Dropdown
  ...
  // 6.Get subcategory for Dropdown
  getSubcategory(inparam: string): Observable<SelectItem[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_subcat_master_maincat_id_drpjson`;
