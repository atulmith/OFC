...
import { Dropdown1 } from '../../state/dropdown1';
...
export class StateService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+"state/";
  }
  /**
  ...
  //1.to insert state
  insert(inparam: State): Observable<States[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_state_mastercreate`;//insertMilestonesProject`;
  ...
  // 2.Update state
  update(inparam: State): Observable<States[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_state_master_update`;//insertMilestonesProject`;
  ...
  getallState(): Observable<State[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_state_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get state
  getedit(pkid: string): Observable<State>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_state_master_selectedit`;//selectEditMilestone`;
...
// 5.Get country for Dropdown
  ...
  getall(): Observable<States[]>{
    ...
    var url2 = `${this.baseUrl}WS_vw_state_country_details_selectjson`;//selectAllMilestone`;
