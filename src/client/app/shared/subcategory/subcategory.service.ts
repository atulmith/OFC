...
import { KeywordSubcat } from '../../subcategory/keywordsubcat';
import {SelectItem} from 'primeng/primeng';
import { Dropdown1 } from '../../subcategory/dropdown1';
...
export class SubcategoryService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+'subcategory/';
  ...
  //1.to insert subcategory
  insert(inparam1: Subcategory,inparam2:KeywordSubcat[]): Observable<Subcategory[]>{
    //Header declaration
    let headers1 = new Headers();
    headers1.append('Content-Type', 'application/x-www-form-urlencoded');
    //Body params
    var body1 = `input0=${JSON.stringify( inparam1)}&input1=${JSON.stringify( inparam2)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_subcat_master_create`;//insertMilestonesProject`;
  ...
  update(inparam1: Subcategory,inparam2:KeywordSubcat[]): Observable<Subcategory[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam1)}&input1=${JSON.stringify( inparam2)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_subcat_master_update`;//insertMilestonesProject`;
  ...
  getall(): Observable<Subcategory[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_subcat_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get subcategory
  getedit(pkid: string): Observable<Subcategory>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_subcat_master_selectedit`;//selectEditMilestone`;
 ...
 //5. for subcategory keyword search
  getSubCatKeyword(pkid: string): Observable<KeywordSubcat[]>{
   ...
   var body1 = `input0=${ pkid}`;
    ...
    var url2 = `${this.baseUrl}WS_vw_subcat_keyword_details_selectjson`;//selectAllMilestone`;
  ...
  getMainCatId(inparam: string): Observable<SelectItem[]>{
