...
export class TermsConditionService {
  ...
  constructor(private http : Http,private baseUrlservice:BaseUrlService){
    this.baseUrl=baseUrlservice.getBaseurl()+'termsconditions/';
  }
  /**
  ...
  insert(inparam: TermsConditions): Observable<TermsConditions[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_termsconditions_create`;//insertMilestonesTermsCondition`;
  ...
  // Update old entry
  update(inparam: TermsConditions): Observable<TermsConditions[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_termsconditions_update`;//insertMilestonesTermsCondition`;
  ...
  // On Edit get data
  getedit(pkid: string): Observable<TermsConditions>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_termsconditions_selectedit`;//selectEditMilestone`;
  ...
  getall(): Observable<TermsConditions[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_termsconditions_selectjson`;//selectAllMilestone`;
