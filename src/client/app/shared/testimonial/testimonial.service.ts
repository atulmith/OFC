...
import { Dropdown1 } from '../../testimonial/dropdown1';
...
export class TestimonialService {
  ...
  constructor(private http : Http,private baseurlservice:BaseUrlService){
    this.baseUrl=baseurlservice.getBaseurl()+"testimonial/";
  }
  /**
  ...
  //1.to insert testimonial
  insert(inparam: Testimonial): Observable<Testimonial[]>{
    //Header declaration
    ...
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_testimonial_master_create`;//insertMilestonesProject`;
  ...
  update(inparam: Testimonial): Observable<Testimonial[]>{
    ...
    var body1 = `input0=${JSON.stringify( inparam)}`;
    // URL declaration
    var url2 = `${this.baseUrl}WS_tbl_testimonial_master_update`;//insertMilestonesProject`;
  ...
  getallTestimonial(): Observable<Testimonial[]>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_testimonial_master_selectjson`;//selectAllMilestone`;
  ...
  // 4.On Edit get testimonial
  getedit(pkid: string): Observable<Testimonial>{
    ...
    var url2 = `${this.baseUrl}WS_tbl_testimonial_master_selectedit`;//selectEditMilestone`;
